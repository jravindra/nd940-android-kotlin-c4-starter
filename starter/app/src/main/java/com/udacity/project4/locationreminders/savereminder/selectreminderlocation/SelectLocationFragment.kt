...
//        TODO: call this function after the user confirms on the selected location
    ...
    private fun setMapStyle(map: GoogleMap) {
        try {
            ...
            if (!success) {
                e("Location Fragement", "Style parsing failed.")
            }
        } catch (e: Resources.NotFoundException) {
            e("Location Fragement", "Can't find style Error: $e")
        }
    }
    ...
    override fun onRequestPermissionsResult(
        ...
        d("Location Fragement", "onRequestPermissionResult")
        if (
        ...
        locationSettingsResponseTask.addOnFailureListener { exception ->
            if (exception is ResolvableApiException && resolve) {
                ...
                try {
                    ...
                    d("Location Fragment", "Error geting location settings resolution: " + sendEx.message)
                }
            } else {
                Snackbar.make(
                    binding.mapContainer,
